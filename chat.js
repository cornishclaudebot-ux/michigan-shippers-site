...
(function () {
  ...
  var KB = [
    ...
    { keys: ["foil", "lid", "lids", "keurig", "k cup", "kcup", "k-cup", "coffee pod", "pods", "metal", "tin", "metallic"],
      a: "Yes! We still print on foil. We make <strong>Keurig-compatible metallic foil lids</strong> that seal single-serve coffee and cocoa cups (we print for Crazy Cups, Green Mountain Coffee, Brooklyn Bean and more), plus durable metal and tin labels most printers won't touch. Foil lids ship on the same 10-days-or-less timeline." },
    ...
    { keys: ["where are you", "location", "address", "spring lake", "located", "find you", "visit", "michigan"],
      a: "We're a family-owned shop in <strong>Spring Lake, Michigan</strong> (17369 Taft Rd, Spring Lake, MI 49456), in business since 1969." },
    ...
    { keys: ["how long in business", "experience", "how many years", "family owned", "established", "history", "1959", "how old"],
      a: "We've been <strong>family-owned and operated since 1969</strong>, that's 57 years putting brands on the shelf." },
